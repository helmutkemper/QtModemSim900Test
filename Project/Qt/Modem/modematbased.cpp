...
String ModemATBased::vlstrSearch;
...
void ModemATBased::setEchoOff ()
{
    ModemATBased::vcacucATString[ 0 ]    =  &modem_echo_off;
    ModemATBased::vcacucATResponse[ 0 ]  =  &modem_modem_ok;
    
    ModemATBased::vceEvent               =  Event::EchoOff;
...
void ModemATBased::internetDataSendByGET ( byte vabtStatus )
{
    ...
    void ModemATBased::deleteSmsById ( byte vabtStatus )
    {
        ...
        ModemATBased::vcacucATString[ 2 ]	 =  &modem_at_command_general_end_line;
        ModemATBased::vcacucATResponse[ 2 ]	 =  &modem_modem_ok;
        ...
        ModemATBased::vcucSMStepCompare      =  0;
        ModemATBased::vcucSMStep			 =  0;
        ModemATBased::vcucSMTotalStep		 =  2;
        ModemATBased::vcascPointerDataModem	 = -1;
        ModemATBased::clearFlags ();
        ModemATBased::StateMachineRun ();
    }
...
void ModemATBased::getRtc ()
{
    ModemATBased::vcacucATString[ 0 ]    =  &modem_rtc_read;
    ModemATBased::vcacucATResponse[ 0 ]  =  &modem_rtc_ok;
...
String ModemATBased::calcDayOfWeek ( int vasiYear, int vasiMonth, int vasiDay )
{
    int a, y, m, d;
    ...
    y = vasiYear - a;
    m = vasiMonth + 12 * a - 2;
    d = ( vasiDay + y + y / 4 - y / 100 + y / 400 + ( 31 * m / 12 ) ) % 7;
    
    String vlstrDayOfWeel[ 7 ] = { "Do", "Se", "Tr", "Qa", "Qi", "Sx", "Sa" };

    return vlstrDayOfWeel[ d ];
}
...
void ModemATBased::getDataModem ()
{
    ...
    if ( ModemATBased::vcsSerialBuffer != "" )
    {
        ModemATBased::processBufferModem ();
    }

    else
    {
        //ModemATBased::StateMachineEvent ( Event::Free, ModemATBased::vceEventDispatchedBy );
    }
}

void ModemATBased::processBufferModem ()
{
    int vlsiIndexOfStart;
    int vlsiIndexOfEnd;
    
            
    if ( ModemATBased::vcsSerialBuffer.endsWith ( "\r\nRING\r\n" ) )
    {
        ModemATBased::vcsSerialBuffer.replace ( "\r\nRING\r\n", "" );
    ...
    if ( ( vlsiIndexOfStart != -1 ) && ( vlsiIndexOfEnd != -1 ) )
    {
        ModemATBased::vlstrSearch         =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart, vlsiIndexOfEnd + 3 );

        ModemATBased::Id    =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart + 14, vlsiIndexOfEnd );
        ...
        ModemATBased::vcsSerialBuffer.replace ( ModemATBased::vlstrSearch, "" );
    }
    ...
    if ( ( vlsiIndexOfStart != -1 ) && ( vlsiIndexOfEnd != -1 ) )
    {
        ModemATBased::vlstrSearch                   =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart, vlsiIndexOfEnd + 7 );

        ModemATBased::SignalQualityDbm =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart + 8, ModemATBased::vcsSerialBuffer.indexOf ( "," ) );
    ...
    vlsiIndexOfStart = ModemATBased::vcsSerialBuffer.indexOf ( "+CLCC: " );
    vlsiIndexOfEnd   = ModemATBased::vcsSerialBuffer.indexOf ( "\r\nOK\r\n", vlsiIndexOfStart );
    if ( ( vlsiIndexOfStart != -1 ) && ( vlsiIndexOfEnd != -1 ) )
    {
        ModemATBased::vlstrSearch                     =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart, vlsiIndexOfEnd );
    ...
    vlsiIndexOfStart =  ModemATBased::vcsSerialBuffer.indexOf ( "+CMGR: " );
    vlsiIndexOfEnd   = ModemATBased::vcsSerialBuffer.indexOf ( "\r\nOK\r\n", vlsiIndexOfStart );
    if ( ( vlsiIndexOfStart != -1 ) && ( vlsiIndexOfEnd != -1 ) )
    {
        ModemATBased::vlstrSearch             =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart, vlsiIndexOfEnd );
        ...
        ModemATBased::Message   =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart + 2, vlsiIndexOfEnd - 5 );
    ...
    //       012345678901234567
    //+CCLK: "14/01/03,23:21:40-12"
    vlsiIndexOfStart = ModemATBased::vcsSerialBuffer.indexOf ( "+CCLK: " );
    vlsiIndexOfEnd = ModemATBased::vcsSerialBuffer.indexOf ( "\"\r", vlsiIndexOfStart );
    if ( ( vlsiIndexOfStart != -1 ) && ( vlsiIndexOfEnd != -1 ) )
    {
        ModemATBased::vlstrSearch             =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart, vlsiIndexOfEnd );
        ...
        ModemATBased::Year      =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart +  1, vlsiIndexOfStart +  1 + 2 );
        ModemATBased::Month     =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart +  4, vlsiIndexOfStart +  4 + 2 );
        ModemATBased::Day       =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart +  7, vlsiIndexOfStart +  7 + 2 );

        ModemATBased::DayOfWeek =  ModemATBased::calcDayOfWeek ( ModemATBased::Year.toInt(), ModemATBased::Month.toInt(), ModemATBased::Day.toInt() );

        ModemATBased::Hour      =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart + 10, vlsiIndexOfStart + 10 + 2 );
        ModemATBased::Minute    =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart + 13, vlsiIndexOfStart + 13 + 2 );
        ModemATBased::Second    =  ModemATBased::vcsSerialBuffer.substring ( vlsiIndexOfStart + 16, vlsiIndexOfStart + 16 + 2 );
        
        if ( ModemATBased::StateMachineEvent != 0 )
        {
            ModemATBased::StateMachineEvent ( Event::RTCRead, ModemATBased::vceEventDispatchedBy );
        }
